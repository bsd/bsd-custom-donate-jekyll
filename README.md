# BSD Tools Custom Donate Builder
...
Create complete wrappers/styled themes here in the Jekyll tool and then compile/preview/test all the css/js on your local Jekyll server until you're ready to install it on EE/the tools.
...
- `/webroot/page/-/donate/`: a local mirror of the file structure that will be hosted in the BSD tools.
